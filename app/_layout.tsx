        ...
        <AuthProvider>
          <GameProvider>
            ...
            <Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: '#EDE8DF' } }}>
              ...
              <Stack.Screen name="manage-quests" options={{ presentation: 'card', animation: 'slide_from_right' }} />
              <Stack.Screen name="manage-categories" options={{ presentation: 'card', animation: 'slide_from_right' }} />
